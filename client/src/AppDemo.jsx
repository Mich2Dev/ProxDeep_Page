          ...
          <div className="flex-1">
            <Routes>
              ...
              <Route path="/diagnostic" element={
                <ProtectedRoute allowedRoles={['client']}><ClientWizard /></ProtectedRoute>
              } />
              <Route path="/proposal/:id" element={
                <ProtectedRoute allowedRoles={['client']}><ClientProposal /></ProtectedRoute>
              } />
              <Route path="/workspace" element={
                <ProtectedRoute allowedRoles={['client']}><Workspace /></ProtectedRoute>
              } />
